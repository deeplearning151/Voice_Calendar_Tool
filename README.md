...
该数据库文件已被 `.gitignore` 忽略，不会提交到 GitHub。
...
建议录制 1 到 2 分钟 demo，展示以下流程：

1. 启动 `python main.py`
2. 输入 `6月4号9点提醒我上课`，展示自动添加成功
3. 在右侧小日历选择日期范围并点击 `Apply`
4. 展示中间多日视图中的日程卡片
5. 点击日程卡片查看详情
6. 在详情弹窗中删除日程
7. 点击“语音输入”，说出一个中文日程指令
8. 添加一个即将到期的日程，展示提醒弹窗和语音播报
